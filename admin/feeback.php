...
try {
    ...
    // Fetch feedback data from tblspfeedback
    $sql = "SELECT * FROM tblhspfeedback";
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light-blue sidebar">
                <div class="position-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="feeback.php">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card border-primary">
                            <div class="card-body table-container">
                                <table class="table table-hover bg-light" id="feedbackTable">
                                    <thead>
                                        ...
                                        <?php if (isset($result) && $result instanceof mysqli_result && $result->num_rows > 0): ?>
                                            <?php while ($row = $result->fetch_assoc()): ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td class="border"><?php echo htmlspecialchars($row['feedback']); ?></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr>
